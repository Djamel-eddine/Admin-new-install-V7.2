<?php return array (
  ...
  'Add new branch' => 'Add new branch',
  '1This value is the radius from your restaurant location, and customer can order food inside  the circle calculated by this radius.' => '1This value is the radius from your branch location  and customer can order products inside  the circle calculated by this radius.',
  'Password' => 'Password',
  'Branch List' => 'Branch List',
  'This value is the radius from your restaurant location, and customer can order food inside  the circle calculated by this radius.' => 'This value is the radius from your branch location  and customer can order oriducts inside  the circle calculated by this radius.',
  ...
  'This location setup is for your Main branch. Carefully set your restaurant location and coverage area. If you want to ignore the coverage area then keep the input box empty.' => 'This location setup is for your Main branch. Carefully set your store location and coverage area. If you want to ignore the coverage area then keep the input box empty.',
